...
if __name__ == '__main__':
    train_dataset = MNIST('~/.pytorch/MNIST', train=True, download=True, transform=transforms.ToTensor())
    test_dataset = MNIST('~/.pytorch/MNIST', train=True, download=True, transform=transforms.ToTensor())
